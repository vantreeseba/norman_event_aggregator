...
( /** @lends <global> */ function (window, document, undefined) {
            ...
            var DataTable = function (oInit) {
                    ...
                    if ((sData = oCol.fnGetData(oData, sSpecific)) === undefined) {
                        if (oSettings.iDrawError != oSettings.iDraw && oCol.sDefaultContent === null) {
                            _fnLog(oSettings, 0, "Requested unknown parameter " +
                                ...
                                " from the data source for row " + iRow + 'at column' + oCol.sTitle);
                ...
                function _fnDraw(oSettings) {
                    ...
                    if (oSettings.aiDisplay.length !== 0) {
                        ...
                        nTd.setAttribute('colSpan', _fnVisbleColumns(oSettings));
    ...
    _fnGetDataMaster(oSettings), oSettings._iDisplayStart, oSettings.fnDisplayEnd(), oSettings.aiDisplay]);
                ...
                function _fnFeatureHtmlFilter(oSettings) {
                    ...
                    var placeholderPolyfill = '<div class="ui-shim-placeholder-frame"><div class="ui-shim-placeholder"></div></div>';

                    var sSearchStr = oSettings.oLanguage.sSearch;
                    sSearchStr = (sSearchStr.indexOf('_INPUT_') !== -1) ?
                        sSearchStr.replace('_INPUT_', '<input type="text" />') :
                        sSearchStr === "" ?
                        '<div><input class="ui-datatables-search" type="text" /></div>' :
                        '<div>' + placeholderPolyfill + ' <input class="ui-datatables-search" type="text" placeholder="' + sSearchStr + '"/></div>';
                    ...
                    var $placeholderPolyfill = jqFilter.parent().find('.ui-shim-placeholder-frame');

                    if ($placeholderPolyfill) {
                        
                        $placeholderPolyfill.on('click.DT', function(){
                            jqFilter.focus();
                        });
                        
                        var $placeholderPolyfillText = $placeholderPolyfill.find('.ui-shim-placeholder')
                        var placeholderText = jqFilter.attr('placeholder')
                        $placeholderPolyfillText.text(placeholderText);
                        jqFilter.attr('placeholder', '');
                    }
                    ...
                    jqFilter.bind('keyup.DT', function (e) {
                        ...
                        if ($(this).val().length) {
                            $placeholderPolyfill.hide();
                        } else {
                            $placeholderPolyfill.show();
                        }
                ...
                function _fnLanguageCompat(oLanguage) {
                    ...
                    if (!oLanguage.sEmptyTable && oLanguage.sZeroRecords &&
                        oDefaults.sEmptyTable === "No data to display. Please adjust your selection(s).") {
                ...
                function _fnSort(oSettings, bApplyClasses) {
                    ...
                    if (!oSettings.oFeatures.bServerSide &&
                        ...
                        for (i = 0; i < aaSort.length; i++) {
                            ...
                            if (oSettings.aoColumns && (oSettings.aoColumns.length - 1 > iColumn)) {
                                iColumn = 0;
                            }
     ...
     oSettings.oClasses.sStripeEven
            ...
            DataTable.defaults = {
                ...
                "oLanguage": {
                     ...
                     *  @type string
                     *  @default No data to display. Please adjust your selection(s).
                     *  @dtopt Language
                     *
                     *  @example
                     *    $(document).ready( function() {
                     *      $('#example').dataTable( {
                     *        "oLanguage": {
                     *          "sEmptyTable": "No data to display. Please adjust your selection(s)."
                     *        }
                     *      } );
                     *    } );
                     */
            ...
            $.extend(DataTable.ext.oJUIClasses, DataTable.ext.oStdClasses, {
                ...
                "sSortJUIAsc": "css_right ui-icon ui-icon-carat-1-n",
                "sSortJUIDesc": "css_right ui-icon ui-icon-carat-1-s",
